...
In Part 1, validation existed, but it was too permissive. In [lib/schemas.ts](C:/Users/lutfi/Downloads/AssignmentRnD/Legit-Company-Site-Part1/lib/schemas.ts):
...
In Part 1, [lib/activityLogger.ts](C:/Users/lutfi/Downloads/AssignmentRnD/Legit-Company-Site-Part1/lib/activityLogger.ts) only inserted rows into the database. It did not support severity levels, request IDs, or structured security-oriented logging. The result was still useful for history, but weaker for investigation and monitoring.

### 6. Unsafe JWT Secret Fallback

In Part 1, [lib/auth.ts](C:/Users/lutfi/Downloads/AssignmentRnD/Legit-Company-Site-Part1/lib/auth.ts) resolved the secret like this:
...
Part 2 introduces [lib/uploads.ts](C:/Users/lutfi/Downloads/AssignmentRnD/Legit-Company-Site-PART2/lib/uploads.ts) and moves file handling behind dedicated helpers.
...
Avatar handling was also corrected. In Part 1, the avatar route always generated a `.jpg` filename. In Part 2, the avatar route in [Legit-Company-Site-PART2/app/api/users/me/avatar/route.ts](C:/Users/lutfi/Downloads/AssignmentRnD/Legit-Company-Site-PART2/app/api/users/me/avatar/route.ts) validates the real content first and stores the avatar using the validated extension.

### 2. Rate Limiting and Abuse Protection

Part 2 adds [lib/rate-limit.ts](C:/Users/lutfi/Downloads/AssignmentRnD/Legit-Company-Site-PART2/lib/rate-limit.ts) and applies it directly in sensitive routes.

In Part 1, the login route moved from parsing to credential checks immediately. In Part 2, [app/api/auth/login/route.ts](C:/Users/lutfi/Downloads/AssignmentRnD/Legit-Company-Site-PART2/app/api/auth/login/route.ts) first checks:
...
Part 2 tightens request schemas in [Legit-Company-Site-PART2/lib/schemas.ts](C:/Users/lutfi/Downloads/AssignmentRnD/Legit-Company-Site-PART2/lib/schemas.ts) and centralizes cleanup logic in [Legit-Company-Site-PART2/lib/security.ts](C:/Users/lutfi/Downloads/AssignmentRnD/Legit-Company-Site-PART2/lib/security.ts).
...
Part 2 also adds admin self-protection. In [Legit-Company-Site-PART2/app/api/admin/users/[id]/route.ts](C:/Users/lutfi/Downloads/AssignmentRnD/Legit-Company-Site-PART2/app/api/admin/users/[id]/route.ts), an admin can no longer remove their own admin role. That check did not exist in Part 1.

### 5. Logging and Monitoring Improvements

In Part 1, [lib/activityLogger.ts](C:/Users/lutfi/Downloads/AssignmentRnD/Legit-Company-Site-Part1/lib/activityLogger.ts) only inserted audit rows into the database:
...
In Part 2, [Legit-Company-Site-PART2/lib/activityLogger.ts](C:/Users/lutfi/Downloads/AssignmentRnD/Legit-Company-Site-PART2/lib/activityLogger.ts) adds:

- severity support
- request ID support
- structured logging through [lib/logger.ts](C:/Users/lutfi/Downloads/AssignmentRnD/Legit-Company-Site-PART2/lib/logger.ts)
...
JWT handling in Part 2 is safer than Part 1. Instead of resolving the secret once with a silent fallback, [Legit-Company-Site-PART2/lib/auth.ts](C:/Users/lutfi/Downloads/AssignmentRnD/Legit-Company-Site-PART2/lib/auth.ts) uses `getJwtSecret()`.
...
Part 2 also adds global response headers in [Legit-Company-Site-PART2/next.config.mjs](C:/Users/lutfi/Downloads/AssignmentRnD/Legit-Company-Site-PART2/next.config.mjs), including:
...
- [Legit-Company-Site-PART2/lib/uploads.ts](C:/Users/lutfi/Downloads/AssignmentRnD/Legit-Company-Site-PART2/lib/uploads.ts)
- [Legit-Company-Site-PART2/lib/security.ts](C:/Users/lutfi/Downloads/AssignmentRnD/Legit-Company-Site-PART2/lib/security.ts)
- [Legit-Company-Site-PART2/lib/rate-limit.ts](C:/Users/lutfi/Downloads/AssignmentRnD/Legit-Company-Site-PART2/lib/rate-limit.ts)
- [Legit-Company-Site-PART2/lib/schemas.ts](C:/Users/lutfi/Downloads/AssignmentRnD/Legit-Company-Site-PART2/lib/schemas.ts)
- [Legit-Company-Site-PART2/lib/activityLogger.ts](C:/Users/lutfi/Downloads/AssignmentRnD/Legit-Company-Site-PART2/lib/activityLogger.ts)
- [Legit-Company-Site-PART2/lib/auth.ts](C:/Users/lutfi/Downloads/AssignmentRnD/Legit-Company-Site-PART2/lib/auth.ts)
- [Legit-Company-Site-PART2/app/api/files/route.ts](C:/Users/lutfi/Downloads/AssignmentRnD/Legit-Company-Site-PART2/app/api/files/route.ts)
- [Legit-Company-Site-PART2/app/api/auth/login/route.ts](C:/Users/lutfi/Downloads/AssignmentRnD/Legit-Company-Site-PART2/app/api/auth/login/route.ts)
- [Legit-Company-Site-PART2/app/api/auth/register/route.ts](C:/Users/lutfi/Downloads/AssignmentRnD/Legit-Company-Site-PART2/app/api/auth/register/route.ts)
- [Legit-Company-Site-PART2/app/api/admin/users/[id]/route.ts](C:/Users/lutfi/Downloads/AssignmentRnD/Legit-Company-Site-PART2/app/api/admin/users/[id]/route.ts)
